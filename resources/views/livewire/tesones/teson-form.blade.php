<div class="max-w-7xl mx-auto py-8 px-4">
    ...
    <div class="flex items-center justify-between mb-8 px-4">
        ...
        <a href="{{ url()->previous() }}" class="btn-flat btn-flat-white">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <select wire:model.live="workplace_id" 
                                    class="input-flat font-bold @error('workplace_id') bg-red-50 @enderror">
                        ...
                        @if($workplace_id)
                            <div class="py-4 border-y border-slate-100 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <span class="text-[9px] font-black text-slate-400 uppercase block">Adscripción</span>
                                    <span class="text-xs font-bold text-slate-900">{{ $adscripcion_snapshot }}</span>
                                </div>
                                <div>
                                    <span class="text-[9px] font-black text-slate-400 uppercase block">Unidad</span>
                                    <span class="text-xs font-bold text-slate-900">{{ $unidad_snapshot }}</span>
                                </div>
                                <div>
                                    <span class="text-[9px] font-black text-slate-400 uppercase block">Lugar</span>
                                    <span class="text-xs font-bold text-slate-900">{{ $lugar_snapshot }}</span>
                                </div>
                            </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <select wire:model="nomina_id" 
                                        class="input-flat h-56 font-semibold @error('nomina_id') bg-red-50 @enderror" 
                                        size="6">
                                    <option value="" disabled class="py-3 text-slate-400 bg-white">--- Seleccione el periodo de nómina correspondiente ---</option>
                                    @foreach($nominas as $id => $nomina)
                                        <option value="{{ $id }}" class="py-3 px-5 hover:bg-blue-50 cursor-pointer border-b border-white last:border-0">{{ $nomina }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <select wire:model="tipo_personal" class="input-flat font-bold @error('tipo_personal') bg-red-50 @enderror">
                        ...
                        <div>
                            ...
                            <select wire:model.live="remision_nomina" class="input-flat font-bold @error('remision_nomina') bg-red-50 @enderror">
                                <option value="">Selecciona...</option>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="input-flat font-mono text-lg @error('folio_inicial') bg-red-50 @enderror" 
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="input-flat font-mono text-lg @error('folio_final') bg-red-50 @enderror" 
                                   placeholder="{{ $placeholder }}">
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="card-premium bg-slate-900 text-white overflow-hidden sticky top-8">
                <div class="p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                ...
                                <span class="px-2 py-0.5 rounded bg-blue-900/40 text-[10px] font-black uppercase tracking-widest text-blue-400">{{ $remision_nomina ? ($formasPago[$remision_nomina] ?? '...') : 'Pendiente' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            @if($folio_inicial || $folio_final)
                                <div class="flex items-center gap-3 mt-2 bg-slate-800/50 p-3 rounded-xl">
                    ...
                    <div class="mt-10 pt-8">
                        <button wire:click="save"
                                class="btn-flat btn-flat-primary w-full">
